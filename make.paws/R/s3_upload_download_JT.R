...
uploadJT <- function(file_name,bucket_name, key, max_file_size = 5368709120){
  #browser()  
...
downloadJT <- function(bucket_name,key,file_name){
  #browser()  
...
downloadJT(bucket,key,file_name)